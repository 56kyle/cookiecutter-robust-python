...
- Docstring/Hint Parsing: **`sphinx.ext.napoleon`{sphinx-ext-napoleon-documentation}** (Google style), **`sphinx-autodoc-typehints`{sphinxautodoctypehints-documentation}**.
